...
import { FolderOpen, Search, Filter, Plus, ChevronRight, AlertCircle, Calendar, MoreVertical } from "lucide-react";
  ...
  if (role === "banco") {
    return (
      <div className="grid gap-6 animate-in fade-in">
        <div className="flex flex-wrap justify-between items-end gap-4 mb-2">
          <div>
            <h2 className="text-2xl font-bold text-navy mb-1">Solicitações e Ofícios</h2>
            <p className="text-sm text-muted">Acompanhe requisições de herdeiros, alvarás judiciais e ordens de transferência.</p>
          </div>
          <div className="flex gap-2">
            <button className="bg-white border border-line text-navy px-4 py-2.5 rounded-xl text-sm font-bold shadow-sm hover:bg-gray-50 flex items-center gap-2">
              <Filter size={16} /> Filtros
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-2 rounded-2xl border border-line shadow-sm">
          <div className="flex gap-1 overflow-x-auto w-full md:w-auto">
            {["Todas", "Análise Jurídica", "Aguardando Documento", "Em Processamento", "Concluídas"].map((tab, i) => (
              <button key={i} className={`px-4 py-2 text-sm font-bold rounded-xl whitespace-nowrap transition-colors ${i === 0 ? "bg-[#f0edff] text-accent" : "text-muted hover:bg-gray-50"}`}>
                {tab}
              </button>
            ))}
          ...
          <div className="relative w-full md:w-64">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-muted" size={16} />
            <input type="text" placeholder="Buscar protocolo..." className="w-full bg-gray-50 border border-line rounded-xl py-2 pl-9 pr-3 text-sm focus:border-accent outline-none" />
          </div>
        </div>
        ...
        <div className="bg-white border border-line rounded-2xl shadow-sm overflow-hidden">
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-gray-50 border-b border-line">
                <th className="py-3 px-5 text-[11px] font-[850] uppercase text-muted tracking-wider">Protocolo / Espólio</th>
                <th className="py-3 px-5 text-[11px] font-[850] uppercase text-muted tracking-wider">Tipo de Solicitação</th>
                <th className="py-3 px-5 text-[11px] font-[850] uppercase text-muted tracking-wider">Agência / Canal</th>
                <th className="py-3 px-5 text-[11px] font-[850] uppercase text-muted tracking-wider">Status</th>
                <th className="py-3 px-5"></th>
              </tr>
            </thead>
            <tbody className="text-sm">
              <tr className="border-b border-line hover:bg-gray-50/50 cursor-pointer transition-colors group">
                <td className="py-4 px-5">
                  <strong className="text-navy block">SOL-2026-9912</strong>
                  <span className="text-muted text-xs block mt-0.5">Espólio: Roberto Almeida</span>
                </td>
                <td className="py-4 px-5">
                  <div className="flex items-center gap-2 text-navy">
                    <span className="text-xs font-bold bg-blue-100 text-blue-700 px-2 py-1 rounded">Transferência de Saldo</span>
                  </div>
                </td>
              ...
              <tr className="border-b border-line hover:bg-gray-50/50 cursor-pointer transition-colors group">
                <td className="py-4 px-5">
                  <strong className="text-navy block">SOL-2026-9915</strong>
                  <span className="text-muted text-xs block mt-0.5">Espólio: Maria Silva</span>
                </td>
                <td className="py-4 px-5">
                  <div className="flex items-center gap-2 text-navy">
                    <span className="text-xs font-bold bg-purple-100 text-purple-700 px-2 py-1 rounded">Encerramento de Conta</span>
                  </div>
                </td>
                <td className="py-4 px-5 text-navy text-xs">
                  Ag. 1290 - Varejo
